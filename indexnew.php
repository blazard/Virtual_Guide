				...
				<div class="col-md-12 col-md-offset-0 text-left">
					<div class="row row-mt-15em">
						<div class="col-md-7 mt-text animate-box" data-animate-effect="fadeInUp">
								<h1>Get the most out of your trips</h1>
						</div>
								...
								<div class="tab">
									...
									<div class="tab-content">
										<div class="tab-content-inner active" data-content="signup">
											<h3>Get to know your destination</h3>
											<form action="#">
												<div class="row form-group">
													<div class="col-md-12">
														<label for="fullname">Enter your Destination</label>
			...
			<div class="row">
				...
				<div class="col-lg-4 col-md-4 col-sm-6">
					<a href="#" class="fh5co-card-item">
						<figure>
							<div class="overlay"></div>
							<img src="images/kuru.jpg" alt="Image" class="img-responsive">
						</figure>
				...
				<div class="col-lg-4 col-md-4 col-sm-6">
					<a href="#" class="fh5co-card-item ">
						<figure>
							<div class="overlay"></div>
							<img src="images/agra.jpg" alt="Image" class="img-responsive">
						</figure>
						<div class="fh5co-text">
							<h2>Agra</h2>
							<p>Far far away, behind the word mountains, far from the countries Vokalia..</p>
				...
				<div class="col-lg-4 col-md-4 col-sm-6">
					<a href="#" class="fh5co-card-item ">
						<figure>
							<div class="overlay"></div>
							<img src="images/manali.jpg" alt="Image" class="img-responsive">
						</figure>
						<div class="fh5co-text">
							<h2>Manali</h2>
							<p>Far far away, behind the word mountains, far from the countries Vokalia..</p>
				...
				<div class="col-lg-4 col-md-4 col-sm-6">
					<a href="#" class="fh5co-card-item">
						<figure>
							<div class="overlay"></div>
							<img src="images/jim.jpg" alt="Image" class="img-responsive">
						</figure>
						<div class="fh5co-text">
			...
			<div class="row">
				<div class="col-md-4 col-sm-6">
					<div class="feature-center animate-box" data-animate-effect="fadeIn">
						...
						<p>The only thing you need to do is to pick a place you want to visit</p>
					</div>
				</div>
				<div class="col-md-4 col-sm-6">
					<div class="feature-center animate-box" data-animate-effect="fadeIn">
						...
						<h3>Duration of your visit</h3>
						<p>Just let us know the duration of your visit and we plan out the perfect itenary for you</p>
					</div>
				</div>
				<div class="col-md-4 col-sm-6">
					<div class="feature-center animate-box" data-animate-effect="fadeIn">
						...
						<h3>Relax and follow</h3>
						<p>Don't be afraid to miss out on any cool spots.We've got you covered.Just follow the itenary and make the most out of your trip</p>
					</div>
				</div>
			</div>
		</div>
	...
	<div id="gtco-counter" class="gtco-section">
		<div class="gtco-container">
			...
			<div class="row">
				<div class="col-md-8 col-md-offset-2 text-center gtco-heading animate-box">
					<h2>Our Success</h2>
					<p>Our customers are our topmost priority and we wish to continue creating memorable experiences for them</p>
				</div>
			</div>
